    ...
    <PageShell>
      <section className="hero container">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><TactileButton href="/setup" variant="primary">Set up Kith for your community</TactileButton><Link href="/demo" className="text-link">See it remember first <ArrowRight size={15} /></Link></div>
      ...
      <section className="cta-band container"><div><span className="eyebrow-pill"><WandSparkles size={13} /> four clicks, no terminal</span><h2>Give your Mind a memory today.</h2><p>Invite the bot, pick a channel, push to your own Mind. Or see the demo first — it's public, deliberate, and honest about what it costs to ask Kith live.</p></div><TactileButton href="/setup">Set up Kith</TactileButton><TactileButton variant="dark" href="/demo">Open the live demo</TactileButton></section>

      <section className="section container vision-section"><div className="vision-copy"><SectionLabel tone="butter">available now</SectionLabel><h2>Your own Mind can become a Kith today.</h2><p>Kith is published as a Skill on the Minds Bazaar. Equip it on your own Mind and it starts reasoning the same way, over your own community — nothing hosted by us, nothing routed through us. Then give it a memory to reason over: our web wizard walks you through connecting Discord and building your first registry, no terminal required.</p><div className="hero-actions" style={{ marginTop: "8px" }}><TactileButton href="/setup">Set up your own Kith</TactileButton><a className="text-link" href="https://hellominds.ai/bazaar/skills" target="_blank" rel="noreferrer">Find "Kith" in the Bazaar <ArrowRight size={15} /></a></div></div><div className="vision-orbit"><div className="orbit orbit--one" /><div className="orbit orbit--two" /><div className="orbit-core"><img src={assetUrls.mark} alt="" /><span>mind<br />to mind</span></div><div className="orbit-note orbit-note--a">memory</div><div className="orbit-note orbit-note--b">care</div><div className="orbit-note orbit-note--c">context</div></div></section>
    </PageShell>
  );
}
