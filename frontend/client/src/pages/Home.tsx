...
export default function Home() {
  return (
    <PageShell>
      ...
      <section className="section container vision-section"><div className="vision-copy"><SectionLabel tone="butter">the bigger idea</SectionLabel><h2>One day, your own Mind can become a Kith.</h2><p>Kith today is one live Mind built for Creative Minds Jam #1. The path to scale is an equippable Skill on the Minds Bazaar, so any creator can give their own community a little more memory.</p><a className="text-link" href="mailto:hello@kith.community?subject=Hear when Kith ships">Hear when this ships <ArrowRight size={15} /></a></div><div className="vision-orbit"><div className="orbit orbit--one" /><div className="orbit orbit--two" /><div className="orbit-core"><img src={assetUrls.mark} alt="" /><span>mind<br />to mind</span></div><div className="orbit-note orbit-note--a">memory</div><div className="orbit-note orbit-note--b">care</div><div className="orbit-note orbit-note--c">context</div></div></section>
    </PageShell>
  );
}
